...
export function cornerTour({
  ...
  return `<div class="tour-page${production ? " tour-still" : ""}" id="top" tabindex="-1"${production ? ' data-production="true"' : ""}>
    <header class="tour-header"><div class="tour-header-inner">
      ...
      <button type="button" class="tour-motion" data-tour-motion aria-pressed="true"${production ? " disabled" : ""}>${icon("play")} <span>3D room</span></button>
      ...
      <div class="tour-run">
        ...
        <div class="tour-chapters">
          <section id="welcome" class="tour-chapter tour-welcome" data-side="right" aria-labelledby="tour-title" tabindex="-1">${alias("welcome")}<div class="tour-copy tour-intro">
            ...
            <div class="tour-intro-proof"><a href="#experience"><strong>170+</strong><span>validated CVEs ↗</span></a><a href="#work"><strong>Open source</strong><span>made to be shared ↗</span></a></div>
            <p class="tour-intro-note">Make yourself at home.<br>Every corner holds a piece of my story.</p>
    ...
    <footer class="tour-footer"><span>A little curiosity goes a long way.</span><a href="#welcome">Back to the beginning ↑</a><div>${production ? `<span>DIMAS MAULANA / DENPASAR, BALI</span><a href="${site}/blog/">Blog</a><a href="${site}/notes/">Notes</a><a href="${site}/tools/">Tools</a><a href="${site}/search/">Search</a><a href="${site}/services/">Services</a><a href="${site}/rss.xml">RSS</a>` : '<span>SCROLL-DIRECTED ROOM TOUR</span><a href="?concept=corner-scroll">Compare scroll-first Corner</a><a href="?concept=corner">Original room</a><a href="?">All concepts</a>'}</div></footer>
...
export function initCornerTour({
  ...
  function update() {
    ...
    roomReveal = mobile.matches
      ? mobileRoomReveal({
          cardTop: metrics[active].cardTop - position,
          cardBottom:
