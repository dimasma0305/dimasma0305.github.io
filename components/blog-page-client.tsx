...
const BlogCategories = lazy(() =>
  import("@/components/blog-categories").then((m) => ({
    default: m.BlogCategories,
  })),
);
          ...
          <Button
            ...
            onClick={() =>
              setVisiblePosts((previous) =>
                Math.min(previous + 6, posts.length),
              )
            }
          >
            Load more posts
...
const Sidebar = memo(() => {
  return (
    <aside className="writing-sidebar" aria-label="Browse writing by topic">
  ...
  return (
    <div className="container px-4 py-12 mx-auto max-w-7xl">
      ...
      <div className="writing-summary">
        <span>
          <strong>{loading ? "—" : posts.length}</strong> published posts
        </span>
        <span>Research, writeups & things I’ve learned.</span>
