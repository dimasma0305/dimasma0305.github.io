    ...
    <div className="flex flex-col sm:flex-row justify-between gap-4 mt-12 pt-6 border-t">
      {prevPost ? (
        <Button
          asChild
          variant="ghost"
          className="flex-1 sm:flex-initial flex items-center gap-2 h-auto p-3 w-full sm:w-auto justify-start"
        >
      ...
      {nextPost ? (
        <Button
          asChild
          variant="ghost"
          className="flex-1 sm:flex-initial flex items-center gap-2 h-auto p-3 w-full sm:w-auto justify-end sm:flex-row-reverse"
        >
